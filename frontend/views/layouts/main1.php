...
<html data-style-switcher-options="{'borderRadius': '0'}">
        ...
        <body>
                ...
                <div class="body">
                        <header id="header" class="header-no-border-bottom" data-plugin-options='{"stickyEnabled": true, "stickyEnableOnBoxed": true, "stickyEnableOnMobile": true, "stickyStartAt": 148, "stickySetTop": "-107px", "stickyChangeLogo": false}'>
                                                ...
                                                <div class="header-row">
                                                        <div class="header-column">
                                                                <div class="header-logo">
                                                                        <a href="<?= Yii::$app->homeUrl; ?>site/index" style="text-decoration:none;" class="site-logo">
                                                                        ...
                                                                        <a href="#" style="text-decoration:none;" class="app-logo">
                                                                                <img alt="" width="" height="" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?= Yii::$app->homeUrl; ?>img/android.png">
                                                                        </a>
                                                                        <a href="#" style="text-decoration:none;" class="">
                                                                                <img alt="" width="" height="" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="<?= Yii::$app->homeUrl; ?>img/apple.png">
                                                                        </a>
                                                                ...
                                                                <ul class="header-extra-info hidden-xs">
                                                                        <li>
                                                                                <div class="feature-box feature-box-style-3">
                                                                                        ...
                                                                                        <div class="feature-box-info">
                                                                                                <h4 class="mb-none" style="font-size:16px;">+97 1535 884 762 </h4>
                                                                        ...
                                                                        <li>
                                                                                <div class="feature-box feature-box-style-3">
                                                                                        ...
                                                                                        <div class="feature-box-info">
                                                                                                <h4 class="mb-none" style="font-size:16px;">mail@gulfpro.com</h4>
                                                        ...
                                                        <div class="header-nav-main header-nav-main-light header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
                                                                ...
                                                                <nav>
                                                                        <ul class="nav nav-pills" id="mainNav">
                                                                                ...
                                                                                <li><?= Html::a('LOGIN/REGISTER', ['login']) ?></li>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                                <div class="narrow-phone">
                                                                        ...
                                                                        <span class="phone">+97 1535 884 762</span>
                                                                </div>
                                                        </div>
                                                </div>
                                        </div>
                                        <div class="footer-copyright">
                                                <div class="container">
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                        <p>© Gulf Pro 2016. All Rights Reserved. Powered by: <a href="http://routesnroots.com/" target="_blank">routes n roots</a></p>
                                                                </div>
                                                                <div class="col-md-4">
