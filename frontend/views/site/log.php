        ...
        <div class="row">
                ...
                <div class="col-md-6" style="border-right: 1px solid #e6e6e6">
                        ...
                        <div class="site-register" id="Registration">
                                ...
                                <?= $form->field($model, 'company_name', ['options' => ['class' => 'form-group required'], 'template' => '<div class="col-sm-12"><label style="font-weight:bold;">Company Name:</label>{input}{error}</div>'])->textInput(['placeholder' => 'Company Name']) ?>
