...
<?= Html::a('<i class="fa-th-list"></i><span> Change Cheque Image</span>', ['master-cheque-design/change-cheque-image?id=' . $model->master_bank_id], ['class' => 'btn btn-warning  btn-icon btn-icon-standalone']) ?>
        <div class = "row">
