	...
	<div class="user-img-form form-inline">
		<input type="hidden" id="bank_status" name="bank_status" value="<?= $bank_details->status ?>"
			   ...
			   'jsOptions' => array(
			       'minSize' => [50, 50],
			       'aspectRatio' => '',
			       'onRelease' => new yii\web\JsExpression("function() {ejcrop_cancelCrop(this); setTimeout(function(){ window.location.href = '" . Yii::$app->homeUrl . 'masters/master-bank/more-details?id=' . $model->id . "'; }, 40);} "),
			       //customization
